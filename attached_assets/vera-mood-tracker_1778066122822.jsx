    ...
    <div style={s.root}>
      ...
      <div style={s.header}>
        <div style={s.headerLeft}>
          <div style={s.ember} />
          <span style={s.brand}>Vera</span>
          <span style={s.brandSub}>mood</span>
        </div>
        <div style={s.tabs}>
...
const css = `
  @import url('https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;1,400;1,500&family=DM+Sans:wght@300;400&display=swap');
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ::-webkit-scrollbar { width: 3px; }
  ::-webkit-scrollbar-thumb { background: #2a2520; border-radius: 2px; }
  textarea::placeholder { color: #3a3530; font-family: 'DM Sans', sans-serif; font-size: 14px; }
  @keyframes fadeUp {
